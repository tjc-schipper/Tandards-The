...
function ready() {
    ...
    jQuery('.widgetWrap ul > li > a,.sidemenu_area ul > li > a,.panelmenu_area ul > li > a,.widgetTop ul > li > a').on('hover',(function (e) {
        "use strict";
	...
	if (isiOS()) {
		...
		jQuery('#mainmenu li.menu-item-has-children > a').on('hover',(
			function (e) {
				"use strict";
...
*/
	...
	if (isMobile()) {	// if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		...
		jQuery('.itemDescriptionWrap').on('hover',(function () {
			"use strict";
			jQuery(this).toggleClass('descriptionShow');
			jQuery(this).find('.toggleDescription').slideToggle();
		}));
